...
Modules with the **Restoration** tag include:
...
.. csv-table::
    ...
    :doc:`dwn/clip-time-series`,"Generate .pdf file containing time series clip on a given set of points"
    ...
    :doc:`dwn/sepal_mgci`,"Calculates SDG 15.4.2: Mountain Green Cover Index at national/sub-regional scale"
