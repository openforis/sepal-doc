...
-    use the following symbols for section headings (from heading 1 to heading 6) :code:`=`, :code:`-`, :code:`^`, :code:`"`, :code:`#`, and :code:`+`.
...
The following custom directives were added to help build our documentation.
