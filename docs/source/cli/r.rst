...
SEPAL instances run on :code:`focal` Ubuntu machines and provide a fully functional :code:`R 4.1.2` environment. This environment is accecible in RStudio, Jupyterlab or the terminal:
